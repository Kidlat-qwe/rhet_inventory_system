...
| `adminSettings.jsx` | Org settings UI: card sections for branding, inventory default, couriers, uniform/shirt sizes, **shirt logos**, Help Assistant + **Snowfall** switches; sticky save bar with dirty-state. |
